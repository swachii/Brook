...
import brooklogo from './images/brooklogo.png'; // Ensure correct path to logo
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3 mb-4">
            ...
            <p>
              Brook is your one-stop destination for a diverse range of books across various genres.
              Explore our collection and embark on new adventures!
            </p>
          </div>
